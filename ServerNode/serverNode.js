...
const server = new OPCUAServer({
    resourcePath: "/ServerNode",
    port: parseInt(process.env.SERVER_NODE_PORT),
    serverInfo: {
        applicationUri: "ServerNode",
        productUri: "NodeOPCUA-ServerNode",
        applicationName: { text: "ServerNode", locale: "en" },
        productUri: "ServerNode",
    },
